    ...
    for number_1 in numbers:
        for number_2 in numbers:
            if number_1 + number_2 == 0:
                pair = [number_1, number_2]
                if number_1 not in used_numbers:
                    pairs.append(pair)
                used_numbers.add(number_1)
                used_numbers.add(number_2)
...
def top_chars(phrase):
    ...
    return [key for key, value in char_dict.items() if value == greatest_number]
